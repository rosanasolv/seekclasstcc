          ...
          <b-row>
              <b-col col="9">
                <b-card class="mapaandar">
                    ...
                    @load="posicionar('Biblioteca', '57%', '43%')"
                    @mouseover="algumacoisa(Biblioteca, Biblioteca.posicaoL, Biblioteca.posicaoT, 'Biblioteca')"
                    @mouseout="limpar('Biblioteca')"
                    src="@/assets/local1.png"
                    />
                
                    <img id="Coordenacao" class="estados" alt="Coordenação"
                    @load="posicionar('Coordenacao', '5%', '65%')"
                    @mouseover="algumacoisa(Coordenacao, Coordenacao.posicaoL, Coordenacao.posicaoT, 'Coordenacao')"
                    @mouseout="limpar('Coordenacao')"
                    src="@/assets/local1.png"
                    />
                    <img id="Recepcao" class="estados" alt="Recepção"
                    @load="posicionar('Recepcao', '60%', '78%')"
                    ...
                    @load="posicionar('BanheirosT', '42%', '21%')"
              ...
              <b-col sm="3">
                  <b-card 
                    ...
                    <b-card-text>
                        ...
                        <a class="linkEstados" @click="algumacoisa(Coordenacao, Coordenacao.posicaoL, Coordenacao.posicaoT, 'Coordenacao')" >Coordenação</a> <br/>
